        ...
        <div className="min-h-screen bg-[#0F1419] flex flex-col">
            ...
            <header className="p-6">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-xl font-semibold text-indigo-400">FinanceAI Pro</span>
                </div>
            </header>
            ...
            <main className="flex-1 flex items-center justify-center p-4">
                ...
                <div className="w-full max-w-md">
                    <div className="bg-[#1A1F2E] border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
                        {/* Icon */}
                        <div className="flex justify-center mb-6">
                            <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl shadow-indigo-500/30">
